...
public abstract class AbstractSorter
{
	...
	protected Comparator<Point> pointComparator = null;// comparator used for point comparison. 
	//	Set by calling setComparator(). It compares 
	...
	public void setComparator(int order) throws IllegalArgumentException
	{
		...
		else if(order == 0) { //compare x-coordinate
			Point.setXorY(true);
		}
		else { //compare y-coordinate
			Point.setXorY(false);
		}
		pointComparator = new Comparator<Point>(){ //Anonymous
			@Override
